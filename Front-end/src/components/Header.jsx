        ...
        <div className="flex h-20 items-center justify-between gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {['Home', 'About Us', 'Our Services', 'Products', 'Contact Us'].map((item) => (
              <a 
                ...
                className="text-[14px] font-semibold text-slate-600 hover:text-blue-600 transition-colors duration-200"
              >
                {item}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <a href="tel:+12345678900" className="text-sm font-extrabold text-blue-900 hover:text-blue-700 block leading-tight">
                  +1 234 567 8900
                </a>
            ...
            <button 
              onClick={onBookClick}
              className="rounded-full bg-teal-500 px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white shadow-md shadow-teal-500/25 transition-all duration-300 hover:bg-teal-600 hover:shadow-lg hover:shadow-teal-600/30 active:scale-95"
            >
              Book Appointment
            </button>
          </div>
        ...
        <div className="lg:hidden border-t border-slate-100 bg-white/95 backdrop-blur-lg px-4 pt-4 pb-6 space-y-3 shadow-lg">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col gap-4">
            <div className="flex items-center gap-3 px-4 text-left">
              ...
              <div>
                <a href="tel:+12345678900" className="text-sm font-extrabold text-blue-900">+1 234 567 8900</a>
            ...
            <button 
              ...
              className="w-full rounded-full bg-teal-500 py-3 text-center text-xs font-bold uppercase tracking-wider text-white shadow-md shadow-teal-500/20 hover:bg-teal-600 transition"
            >
              Book Appointment
            </button>
          </div>
