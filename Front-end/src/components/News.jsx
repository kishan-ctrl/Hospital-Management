  ...
  return (
    <section id="products" className="py-24 bg-white border-t border-slate-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Header Row */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-16 text-left">
          <div>
          ...
          <button 
            ...
            className="inline-flex items-center gap-2 rounded-full border-2 border-slate-200 bg-white px-6 py-3 text-xs font-bold uppercase tracking-wider text-slate-700 transition duration-300 hover:border-blue-600 hover:text-blue-600 hover:bg-blue-50/20 shrink-0"
          >
            View All Articles
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          {articles.map((article, idx) => (
            <article key={idx} className="premium-hover-card rounded-3xl bg-slate-50 border border-slate-100 overflow-hidden flex flex-col justify-between">
              <div>
                ...
                <div className="p-6 space-y-3.5">
                  ...
                  <h3 className="text-base font-extrabold text-blue-950 hover:text-blue-600 transition">
